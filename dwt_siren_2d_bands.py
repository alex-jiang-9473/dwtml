...
MODEL_ITERATIONS = 1000 # Max training iterations. Auto-scales up for small/complex inputs
...
OUTPUT_FILE = f"dwt_2d_bands_levels{LEVELS}_{WAVELET}_thresh{THRESHOLD_FACTOR}.png"
...
def main():
    ...
    adaptive_ll_size = max(32, min(MODEL_LAYER_SIZE, int(32 * log_pixels - 32)))
    ...
    def get_adaptive_hf_params(num_coeffs):
        ...
        size = max(32, min(MODEL_LAYER_SIZE, int(32 * log_coeffs - 32)))
